...
//----------------------------------------------------------
int ofVideoGrabber::getAvailableDevicesNum(){
	if(	grabber != NULL ){
		numAvailableDevices = grabber->getAvailableDevicesNum();
	}
	return (int)numAvailableDevices;
}

//----------------------------------------------------------
int* ofVideoGrabber::getAvailableIDs(){
	if(	grabber != NULL ){
		availableIDs = grabber->getAvailableIDs();
	}
	return (int*)availableIDs;
}

//----------------------------------------------------------
string* ofVideoGrabber::getAvailableNames(){
	
	if(	grabber != NULL ){
		availableNames = grabber->getAvailableNames();
	}
	return (string*)availableNames;
