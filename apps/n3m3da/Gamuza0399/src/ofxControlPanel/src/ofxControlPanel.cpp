...
void ofxControlPanel::update(){
	...
	{
		saveButton       = ofRectangle(boundingBox.x + 600 + displayText.getTextWidth() + 20, boundingBox.y + 4, MAX(40, 8 + displayText.getTextWidth("save")) , MAX(12, displayText.getTextSingleLineHeight()) );
