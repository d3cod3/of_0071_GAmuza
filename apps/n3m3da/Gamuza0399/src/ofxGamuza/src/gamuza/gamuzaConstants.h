#define GAMUZA_RELEASE                  "0.4.1"

// MAIN.CPP WINDOW VARS
#define MAIN_WINDOW_W					1280
...
#define GAMUZA_CONSOLE_LOG_ADDRESS      "/GAmuzaLogLine"
#define GAMUZA_CONSOLE_ERROR_ADDRESS    "/GAmuzaErrorLine"
